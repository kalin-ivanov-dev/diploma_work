<x-layout>
    <style>
        .gradient {
            background: linear-gradient(90deg, #65d4ff 0%, #3b82f6 100%);
        }
    </style>
    ...
    <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="w-full md:w-3/5 py-6 text-center">
                <img class="w-full md:w-4/5 z-50 mx-auto" src="{{asset('storage/images/cityscape2.png')}}" />
            </div>
        </div>
    </div>
        ...
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full sm:w-1/2 p-6">
                    <img class="w-full md:w-4/5 z-50 mx-auto" src="{{asset('storage/images/person.png')}}" />
                </div>
            </div>
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <img class="w-full md:w-2/3 z-50 mx-auto" src="{{asset('storage/images/group.png')}}" />
                </div>
                <div class="w-full sm:w-1/2 p-6 mt-6">
